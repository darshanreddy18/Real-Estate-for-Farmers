...
public class RegisterActivity extends AppCompatActivity {
    ...
    EditText etUserName, etAddressLine1, etAddressLine2, etCity, etMobile,etState,etEmailID;
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (conn == null) {
                        ...
                        String query2 = "Insert into tblUsers (ID,UserName,AddressLine1,AddressLine2,City,State,Mobile,EmailID) " +
                                "values ('" + UserID + "','" + etUserName.getText().toString().trim() + "'," +
                        ...
                        query2 = "Insert into tblLogin (UserID,Password,UserType,UserName) values " +
                                "('" + etMobile.getText().toString().trim() + "','" + pwd + "','User'," +
