...
public class InfoActivity extends NavigationDrawerBaseActivity {
    ...
    EditText etOwnerName,etAddressLine1,etAddressLine2,etCity,etState,etMobile,etEmailID;
    Button btnUpdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (conn == null) {
                ...
                String query1 = "Select * from tblOwners where Mobile='" + user_id + "'";
            ...
            public void onClick(View view)
            {
                ...
                try {
                    ...
                    if (conn == null) {
                        ...
                        String query2 = "Update tblOwners set OwnerName='" + etOwnerName.getText().toString() + "'," +
